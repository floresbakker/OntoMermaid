...
Still to do:
16. AnnotationProperty
17. owl:Axiom
18. NodeShape

### Example

Using the tool in this repository we can transform any ontology into a diagram. Let us take the Organization ontology as an example. For reasons of brevity, let's zoom in on some aspects of the model:
...
```
This Mermaid code is contained in a generated HTML-file using the tool mermaid.py. Here is the example result:
